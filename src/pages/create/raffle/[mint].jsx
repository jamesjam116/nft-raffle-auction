...
export default function NewRaffle() {
  ...
  const handleFirstChange = (event) => {
    ...
    for (let item of SPL_TOKENS) {
      if (item.address === event.target.value) name = item.tokenName;
    }
    setFirstToken({
      tokenName: name,
  ...
  const handleCreate = async () => {
    ...
    if (
      buyType === "spl-spl" &&
      (secondSplPrice === 0 || firstSplPrice === 0)
    ) {
      errorAlertCenter("Please enter the ticket price.");
      return;
    }
  ...
  return (
    <>
      <Head>
        <title>Monkai | Create Mint</title>
      </Head>
      <div className="new-raffle">
        <h1 className="create-raffle-title">CREATE RAFFLE</h1>
                ...
                <div className="col-half">
                  <div className="form-control">
                    ...
                    <p className="input-helper">
                      The maximum number of tickets is 1000.
                    </p>
                  </div>
                </div>
                <div className="col-half">
                ...
                <div className="col-half">
                  {rewardType === "wl" && (
                    <div className="form-control">
                      ...
                      />
                      <p className="input-helper">
                        The maximum number of count is 200.
                      </p>
                    </div>
                  )}
                </div>
                      ...
                      <FormControl fullWidth>
                        ...
                        >
                          {SPL_TOKENS.map((item, key) => (
                            <MenuItem value={item.address} key={key}>
                              {item.tokenName}
                            </MenuItem>
                          ))}
                        </Select>
