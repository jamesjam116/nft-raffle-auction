...
export default function NewRaffle({ startLoading, closeLoading }) {
  ...
  const [intervalSecond, setIntervalSecond] = useState(300);
  ...
  const handleCreate = async () => {
    ...
    if (intervalSecond < 160) {
      errorAlertCenter("Invalid interval time. Min value is 160");
      return;
    }
  ...
  return (
    <>
      <Head>
        <title>Monkai | Create Auction</title>
      </Head>
